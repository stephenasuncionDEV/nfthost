    ...
    return (
        ...
        >
            <Flex flexDir='column' maxW='900px' w='full' flex='1' alignItems='center'>
                <Heading as='h1' mt='1em' fontSize='64pt' textShadow='4px 4px 4px black' textAlign='center' fontFamily='silkscreen'>
                ...
                <Divider mt='1em' />
                <Text textAlign='center' mt='1em' textShadow='4px 4px 4px black' fontFamily='silkscreen'>
