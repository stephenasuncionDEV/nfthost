            ...
            >
                ...
                <Flex flexDir='column' justifyContent='center' alignItems='center' flex='1'>
                    <Flex maxW='1355px' w='full' justifyContent='space-between' p='2em'>
                        <Flex flexDir='column' maxW={!isCollapse ? '580px' : 'inherit'} alignItems='flex-start' flex='1'>
                        ...
                        {!isCollapse && (
                            <Flex flexDir='column' position='relative' flex='1' overflow={isHideOverflow ? 'hidden' : 'visible'}>
                                <Image 
                                    position='absolute' 
                    ...
                    <SlideFade in={true} offsetY='20px' delay={1}>
                        <Flex flexDir='column' alignItems='center' justifyContent='center' mt='6em'>
