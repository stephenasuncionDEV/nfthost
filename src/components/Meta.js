...
const Meta = ({ title }) => {
    return <Head>
        ...
        <meta name="description" content='NFT Host is a website where you can generate NFT collections and create an NFT minting website. Metadata utilities available for post-generation.' />
        ...
        <meta property="og:description" content='NFT Host is a website where you can generate NFT collections and create an NFT minting website. Metadata utilities available for post-generation.' />
        ...
        <meta property="twitter:description" content='NFT Host is a website where you can generate NFT collections and create an NFT minting website. Metadata utilities available for post-generation.' />
